...
const DEFAULT_API_BASE_URL = 'https://api-ask-sport-dev.dedicateddevelopers.us/api/';
const DEFAULT_MEDIA_BASE_URL = 'https://api-ask-sport-dev.dedicateddevelopers.us';
...
export const runtimeEnv = {
  ...
  appEnv: resolveAppEnvironment(extra.appEnv ?? process.env.APP_ENV),
  easProjectId:
